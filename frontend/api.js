...
async function getJobs() {
    ...
    return all.filter(j => j.status === 'open').sort((a, b) => b.posted_at.localeCompare(a.posted_at));
}
...
// Mercury scoring — client-side implementation
...
function mercuryScore(records, fields) {
